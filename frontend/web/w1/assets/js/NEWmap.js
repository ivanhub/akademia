...
function init() {
    var groups = [
            ...
            ]},
        {
            ...
            descr: "г. Самара, ул. Осипенко, 11. Время работы 8:00-18:00.<br/>Тел.: +7 (846) 255-69-99",
            items: [
                {
...
counter=0,
 ...
 BalloonContentLayout3 = ymaps.templateLayoutFactory.createClass(
  '<div class="ballon"><img style="background: transparent;  border: none;border-radius: none;padding: 0px; margin-right: 3px;" src="images/map/logo2.png" class="ll"/><p style="padding-top: 7px;padding-left:65px;margin:7px 0px;">г. Самара, ул. Осипенко, 11.<br/> Время работы 8:00-18:00<br/>Тел.: +7 (846) 255-69-99</p><img class="close" id="close" style="background: transparent;  border: none;border-radius: none;padding: 0px;" src="images/map/close.png"/></div>', {
