...
$this->registerMetaTag(['name' => 'keywords',
    'content' => 'права на квадроцикл, права на снегоход, трактор, погрузчик, каток, квадроцикл, эскаватор, права, получить права, росавтоакадемия,
    обучению судовождению, школа судовождения, судовождение, рос автоакадемия, росавто академия, обучение на права, сдать на права, Автошкола Самары №1, самара',
]);
