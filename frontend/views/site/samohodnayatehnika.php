...
$this->registerMetaTag(['name' => 'description',
    'content' => 'Обучение вождению на квадроцике и снегоходе. Права на самоходные машины: трактор, погрузчик, гусечные и колесные машины и т.д. Собственный автодром, опытные квалифицированные инструктора, экстремальное и защитное вождение. Доступные цены. Беспроцентная рассрочка! Одна из лучших автошкол в Самаре. Звоните!',
]);

$this->registerMetaTag(['name' => 'keywords',
    'content' => 'права на квадроцикл, права на снегоход, трактор, погрузчик, каток, квадроцикл, экскаватор, права, спецтехнику, самоходная техника, самоходные машины, гусеничные машины, колесные машины, внедорожные транспортные средства, мототранспортные, получить права, росавтоакадемия, обучению вождению, школа вождения, вождение, автошкола, обучение',
]);
