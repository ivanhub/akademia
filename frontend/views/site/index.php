...
<div class="" style="margin-left:5px;margin-top:-7px;"><img src="https://росавтоакадемия.рф/images/pics/sale50.png" class="flag"><p class="speshite" style="margin-left:99px;padding-top:6px;">Спешите!</p></div> 
...
<span style="font-size:35px;">р.</span></p>
<div class="" style="margin-left:5px;margin-top:-7px;"><img src="https://росавтоакадемия.рф/images/pics/sale.png" class="an-flick" style="float:left"><p class="speshite" style="margin-left:99px;padding-top:6px;">Звоните!</p></div> 
...
<p class="outlineA" style="font-size:50px;color:#f9fa83;margin-top:-30px"><span class="pyat count">10000</span>
<span style="font-size:35px;">р.</span></p>
 <div class="" style="margin-left:5px;margin-top:-16px;"><img src="https://росавтоакадемия.рф/images/pics/sale50.png" class="flag "><p class="speshite"  align="center" style="line-height:.9;font-size:18px;margin-left:98px;padding-top:6px;">Количество мест ограничено!</p></div> 
...
function startCounter() {
    if (jQuery(window).scrollTop() > jQuery(".outlineA").offset().top -660) {
...
jQuery(window).scroll(startCounter);
function startCounter() {
    if (jQuery(window).scrollTop() > jQuery(".line").offset().top -700) {
        jQuery(window).off("scroll", startCounter);
